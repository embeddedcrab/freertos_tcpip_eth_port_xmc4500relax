...
/* Callback handler for user */
	...
	extern void uart_callback_handler(eUART_Channel_& channel, unsigned char *p_data, eUART_Event_ event);
#endif
...
public:
	 ...
	 *
	 */
	long init( const eUART_Init_& init = eUART_Init_::UART_INIT_OPEN );
	 ...
	 *
	 */
	long set_baudrate( const unsigned long& speed = 9600 );
	 ...
	 *
	 */
	long abort( const eUART_Abort_& tx_rx );
