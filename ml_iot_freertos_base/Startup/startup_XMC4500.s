...
/* ======  Definition of the default weak SystemInit_DAVE4 function =========
If DAVE3 requires an extended SystemInit it will create its own version of
SystemInit_DAVE4 which overrides this weak definition. Example includes
...
SystemInit_DAVE4:
     NOP
     BX LR
     .size SystemInit_DAVE4, . - SystemInit_DAVE4
/* ======================================================================== */
/* ======================================================================== */
